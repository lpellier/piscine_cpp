...
/*   Updated: 2021/06/16 14:54:08 by lpellier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap() : _name("Basic Fuck") {
	std::cout << "FR4G-TP " << this->_name << " : Default constructor called" << std::endl;
	this->_hitPoints = 100;
...
FragTrap::~FragTrap() {
	std::cout << "FR4G-TP " << this->_name << " : Destructor called" << std::endl;
}

FragTrap::FragTrap(FragTrap const & src) {
	this->_name = src.getName();
	std::cout << "FR4G-TP " << this->_name << " : Copy constructor called" << std::endl;
